...
FOLDERS = [
    ...
    ("/media/thiago-dias/BACKUP/Datasets/CrossMatch_FLARE_SPLIT", "../scores/FLARE"),
    ("/media/thiago-dias/BACKUP/Datasets/CrossMatch_FLARE_PRIORENH_SPLIT", "../scores/FLARE_PRIORENH"),
    ("/media/thiago-dias/BACKUP/Datasets/CrossMatch_FLARE_UNETENH_SPLIT", "../scores/FLARE_UNETENH"),
    ("/media/thiago-dias/BACKUP/Datasets/UareU_FLARE_SPLIT", "../scores/FLARE"),
    ("/media/thiago-dias/BACKUP/Datasets/UareU_FLARE_PRIORENH_SPLIT", "../scores/FLARE_PRIORENH"),
    ("/media/thiago-dias/BACKUP/Datasets/UareU_FLARE_UNETENH_SPLIT", "../scores/FLARE_UNETENH")
]
GPU = "0"
POSE = "RegressionPose"
BINARY = False
...
def valid_desc(dataloader, model):
    ...
    logging.info(
        f"Average time for each image is {total_time / len(dataloader.dataset):.2e}s"
    )
...
def matching(config):
    ...
    score_file = (
        os.path.join(feat_folder, f"score_{config.NAME}.csv")
